  ...
  return (
    <StudentGuard>
      <Layout>
        <div
          className={
            " w-screen h-screen bg-white flex flex-row justify-center py-40 mb-50 overflow-x-hidden mb-5"
          }
          dir={"rtl"}
        >
          <form
          ...
          >
            <div className={"text-[#222831] w-full grid grid-cols-2 gap-4 mt-96"}>
