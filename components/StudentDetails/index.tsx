    ...
    <>
      ...
      >
        ...
        <div className="profile-info flex w-2/3 justify-between bg-white shadow-md rounded-lg p-4 mt-4 max-auto">
          <div className="profile-details flex flex-row align-center justify-center w-full space-x-6 lg-x-12 ">
            <div className="profile-picture-container w-1/6 flex items-start justify-start pl-11">
              {profile.pictureUrl && (
                <img
        ...
        <div className="profile-buttons flex justify-between mt-4">
          <a href="/RatingPage">
            <button className="profile-button w-full py-2 px-4 bg-gray-700 text-white rounded-lg hover:bg-gray-900">
              امتیازدهی
            </button>
          </a>
          <a href="/professor-home">
            <button
              className="profile-button w-full py-2 px-4 bg-gray-700 text-white rounded-lg hover:bg-gray-900 mr-4"
